...
# And we have to let llm know through its prompts of their existence
...
# Now I will update the code_writer_agent prompt because it has these tools 
...
code_executor_agent = ConversableAgent(
    ...
    default_auto_reply="Please continue.If eveything is done, reply 'TERMINATE'.",
)
